...
//   List of users
  var users = {
    ...
    features: [
      ...
      },
      {
        ...
        geometry: {
          type: "Point",
          coordinates: [-77.149766, 38.980772]
        },
        properties: {
            name: "Guitarist",
  ...
  $("#formBtn").on("click", function() {
    var userNameInput = $("#userName")
      .val()
      .trim();
    var userAddressInput = $("#userAddress")
      .val()
      .trim();
    ...
    //   Appends new user, runs pin display function
    ...
    // Geocoder
    // Converts address into longitude and latitude cords
    const geoUrl =
      "https://api.mapbox.com/geocoding/v5/mapbox.places/" +
      cityName +
      "%2C%20" +
      stateName +
      "%2C%20United%20States.json?access_token=" +
      mapboxgl.accessToken +
      "&cachebuster=1554243021563&autocomplete=true";
    ...
    //   Waits until address is converted
    }).then(function() {
      const distUrl =
        "https://api.mapbox.com/directions/v5/mapbox/driving/-73.989%2C40.733%3B" +
        longitude +
        "%2C" +
        latitude +
        ".json?access_token=" +
